...
### 69. A stale onboarding draft never expired, and nearly doubled the page it opened — `done`
...
### 70. `npm run onboard` said it opens the onboarding page, and did so only sometimes — `done`
