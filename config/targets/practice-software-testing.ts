...
/**
 * practice-software-testing — the application under test is configuration, not code (§04).
 *
 ...
 */
export const practiceSoftwareTesting: TargetProfile = {
  ...
  credentials: {
    ...
    root: 'qa/practice-software-testing/pools',
  ...
  capabilities: {
    ...
    contracts: { enabled: true, spec: 'src/targets/practice-software-testing/contracts/openapi.json' },
    a11y: {
      enabled: true,
